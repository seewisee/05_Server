...
items: 반복 접근할 객체명(Collection 객체) // 향상된 for 문
...
- 제공되는 값
	...
	<form action="forResult.jsp" method="get">
		...
		javascript <br> <input type="checkbox" name="lang" value="jQuery">
		jQuery <br> <input type="checkbox" name="lang" value="servlet">
		servlet <br> <input type="checkbox" name="lang" value="jsp">
		jsp <br>
		<button>제출</button>
	</form>
</body>
